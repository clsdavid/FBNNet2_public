...
buildProbabilityTreeOnTargetGene <- function(targetGene, mainParameters, genes, matchedgenes, matchedexpression, maxK = 4L, temporal = 1L, targetCounts = NULL, findPositiveRegulate = FALSE, 
    findNegativeRegulate = FALSE) {
    .Call(`_FBNNet_buildProbabilityTreeOnTargetGene`, targetGene, mainParameters, genes, matchedgenes, matchedexpression, maxK, temporal, targetCounts, findPositiveRegulate, 
