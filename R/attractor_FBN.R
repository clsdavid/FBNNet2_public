...
#'@param startStates A list of initial states, the row names of each state must be matched with the genes
...
#' attractor<-searchForAttractors(NETWORK2,initialStates,network$genes)
#' print(attractor)
...
#'@param fixIndices, a vector of gene indexes that are intended to be fixed
