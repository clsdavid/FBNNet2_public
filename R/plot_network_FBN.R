...
#' @export
plotNetwork <- function(FBNNetwork, target_genes = c(), type = c("static", "staticSlice", "dynamic", "forward_1a", "forward_2a", "forward_3a", "forward_4a", 
  "backward_1a", "backward_2a", "forward_1b", "forward_2b", "forward_3b", "forward_4b", "backward_1b", "backward_2b"), expand_level = 2, output_network = FALSE, 
  timeseries_matrix = NULL, start_time_point = 1, end_time_point = 1, target_time_point = 1) {
  ...
  switch(type, static = {
    ...
    FBNNetwork <- findForwardRelatedNetworkByGenes(FBNNetwork, target_gene_list = target_genes, regulationType = 0, target_type = 0, maxDeep = 2, 
      next_level_mix_type = FALSE)
    FBNNetwork.Graph(FBNNetwork)
  }, forward_2a = {
    FBNNetwork <- findForwardRelatedNetworkByGenes(FBNNetwork, target_gene_list = target_genes, regulationType = 0, target_type = 1, maxDeep = 2, 
      next_level_mix_type = FALSE)
    FBNNetwork.Graph(FBNNetwork)
  }, forward_3a = {
    FBNNetwork <- findForwardRelatedNetworkByGenes(FBNNetwork, target_gene_list = target_genes, regulationType = 1, target_type = 0, maxDeep = 2, 
      next_level_mix_type = FALSE)
    FBNNetwork.Graph(FBNNetwork)
  }, forward_4a = {
    FBNNetwork <- findForwardRelatedNetworkByGenes(FBNNetwork, target_gene_list = target_genes, regulationType = 1, target_type = 1, maxDeep = 2, 
      next_level_mix_type = FALSE)
    FBNNetwork.Graph(FBNNetwork)
  }, forward_1b = {
    FBNNetwork <- findForwardRelatedNetworkByGenes(FBNNetwork, target_gene_list = target_genes, regulationType = 0, target_type = 0, maxDeep = 2, 
