    ...
    bool findNegativeRegulate = false)
{
    ...
    for(int i=0;i<len;i++){
       ...
       CharacterVector vgene = CharacterVector::create(new_genes[i]);
      ...
      if(!matchedexpression.isNull())
      {
       ...
       if(preprocessed.length()>0){
          if(is_true(any(a_in_b(vgene,preprocessed)))){
             continue;
          }
       }
       ...
       double pickT_mutualInfo = probabilityOfFourCombines_P["pickT_mutualInfo"];
       ...
       double pickF_mutualInfo = probabilityOfFourCombines_N["pickF_mutualInfo"];
       ...
       CharacterVector activator = CharacterVector::create(_["factor"]=pick_expT,
                                                           ...
                                                           _["p_value"]=(String)p_value_P,
                                                           _["mutualInfo"]=(String)pickT_mutualInfo);
       ...
       CharacterVector inhibitor = CharacterVector::create(_["factor"]=pick_expF,
                                                           ...
                                                           _["p_value"]=(String)p_value_N,
                                                           _["mutualInfo"]=(String)pickF_mutualInfo);
